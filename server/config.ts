...
import { ChatbotConfig, DEFAULT_CONFIG, PERSONA_TEMPLATES } from './types.js';
...
export class ConfigManager {
  ...
  public updatePersona(personaName: string, persona: any) {
    this.config.personas[personaName] = persona;
  }

  // Create context-aware system prompt
  public createSystemPrompt(personaName: string, context?: any): string {
